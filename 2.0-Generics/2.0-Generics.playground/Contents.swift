...
//func closures<T>(first:(T)->Void, second:(T)->Void)->((T)->Void){
//    return {_ in first()
//        second()
//    }
//} немного не понял, каким должно быть тело функции
...
extension Array where Element: Comparable{
    var maxEl: Element? { return self.max() }
}
...
var array = [5, 6, 7, 3, 6, 33, 6, 18, 15, 5]
...
infix operator <*
func <*<T: UITableViewDelegate>(delegate: T, tableView: UITableView){
